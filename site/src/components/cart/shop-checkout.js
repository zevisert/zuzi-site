...
export class ShopCheckout extends connect(store)(LitElement) {
      ...
      <section>
        <article>
          ...
          <underline-input
            type="text"
            id="cust-name"
            placeholder="Name${this._paymentMethod === CHECKOUT_METHODS_ENUM.STRIPE
              ? " on card"
              : ""}"
          >
          </underline-input>
        ...
        <article>
          ...
          <underline-input type="email" id="cust-email" placeholder="Contact Email">
          </underline-input>
        </article>
        ...
        <section>
          <article>
            ...
            ${this._paymentMethod === CHECKOUT_METHODS_ENUM.STRIPE
              ? html` <div id="payment-method" class="card-mount">
                  <slot name="stripe-card"> </slot>
                  <div id="card-errors"></div>
                </div>`
              : html`
                  <p id="payment-method">
                    Continue with Interac E-Transfer. Instructions will be emailed to
                    you.<br />
        ...
        <section class="checkout-group">
          ...
          <button
            id="checkout"
            ?disabled="${this._paymentMethod === CHECKOUT_METHODS_ENUM.STRIPE &&
            !this._cardComplete}"
  ...
  _checkoutButtonClicked() {
    ...
    let checkout = () =>
      checkoutFailed("Please review the highlighted inputs. Some seem to be invalid.");
  ...
  _validateInput() {
    ...
    const items = Object.values(this._items).map((cartItem) => {
      return {
