...
import { createEmailSubscriber } from "../../actions/subscriptions";

export class EmailSubscriptionSetup extends LitElement {
  static get is() {
    return "email-subscription-setup";
  }
    ...
    return html`
      ...
      <div class="email">
        <label for="email-subscription-input"
          >Sign up for notifications with your email</label
        >
        <underline-input
        ...
        ></underline-input>
        <button id="email-subscription-button" disabled @click=${this.emailSub}>
          Subscribe
        </button>
      </div>
    `;
