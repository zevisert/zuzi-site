...
export async function create(ctx) {
  ...
  try {
    ...
    body.active =
      typeof body.active === "boolean" ? body.active : body.active === "true";
    body.display_position =
      typeof body.display_position === "number"
        ? body.display_position
        : +body.display_position;
    body.should_watermark =
      typeof body.should_watermark === "boolean"
        ? body.should_watermark
        : body.should_watermark === "true";
...
export async function update(ctx) {
  ...
  try {
    ...
    post.display_position =
      body.display_position !== undefined
        ? body.display_position
        : post.display_position;
